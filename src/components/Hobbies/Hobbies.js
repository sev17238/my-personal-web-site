        ...
        <section className={classes.sectionHobbies}>
            <div id="hobbies" className={classes.Hobbies}>
                <div className={classes.innerDivHobbies}>
                    ...
                    <Row className='row rowMarginHobbies'>
                        <Col xs="2" >
                        </Col>
                        <Col xs="8" >
                            <div >
                                <p className={classes.pHobbiesDescription}>I like to play the piano! I think music is a cool 
                                way to express yourself to others. Though, it helps you remind good thinks and moments of life.
                                </p>
                            </div>
                        </Col>
                        <Col xs="2" >
